...
is edge-biconnected.
\begin{proofof}{Proof of Proposition~\ref{prop:ks-biconn}}
Given a minimal Kochen-Specker graph~$G$.
\parpic[r]{%
%\parpic(0cm,1cm)[r]{%
    \begin{tikzpicture}[thick,scale=1.4,
...
\begin{proofof}{Proof of Proposition~\ref{prop:ks-triconn}}
