    ...
    \begin{tikzpicture}[thick,scale=1.4]
        \draw
            \foreach \x in {0,90,180,270} {
                (\x+45:1) node{} -- (\x+65:1.3) node{}
                (\x+45:1)  -- (\x+25:1.3) node{}
                (\x+65:1.3)  -- (\x+25:1.3)
            }
            \foreach \x in {0,180} {
                (\x:0.8) node{} -- (\x+25:1.3)
...
\begin{comp}\label{comp:unemb20}
    ...
    \begin{center}
        ...
        \begin{tikzpicture}[thick,scale=1.4]
            \draw
                \foreach \x in {0,180} {
                    (\x+15:1.3) node{} -- (\x+90:0.9) node{}
                    (\x+15:1.3) -- (\x+45:0.5) node{}
                    (\x+45:0.5) -- (\x+90:0.9)

                    (\x-15:1.3) node{} -- (\x-90:0.9)
                    (\x-15:1.3) -- (\x-45:0.5) node{}
                    (\x-45:0.5) -- (\x-90:0.9)
        ...
        \begin{tikzpicture}[thick,scale=1.4]
            \draw
                ...
                (75:1) node{} -- (15:1.3) -- (45:0.5) -- (75:1)
                (285:1) node{} -- (345:1.3) -- (315:0.5) -- (285:1)

                (0:1.3) node{} -- (180:0.8) node{}
                (0:1.3) -- (15:1.3)
                (0:1.3) -- (345:1.3)
