...
\end{center}
\caption{Unique non 010-colorable squarefree connected
...
vertices. Its depicted in Figure~\ref{fig:c17}
It is not embeddable, as the graph in Figure~\ref{fig:unemb-10-2}
is an unembeddable subgraph.  See Proposition~\ref{prop:unemb-10-2}.
